...
"""
        ...
        for rank, (feature, attribution) in enumerate(top_features, 1):
            ...
            if attribution > 0:
                ...
                impact = (
                    "hurt"
                    if prediction == 0
                    else "was not ideal, but other factors compensated"
                )
    ...
    def _verify_citations(
        self, explanation: Dict[str, Any], evidence: Dict[str, Any]
    ) -> Dict[str, Any]:
        """
        ...
        for cite_id in cited_ids:
            ...
            if not found:
                ...
                text = text.replace(
                    f"[Policy Reference: {cite_id}]", "[Citation Removed: Unverified]"
                )
