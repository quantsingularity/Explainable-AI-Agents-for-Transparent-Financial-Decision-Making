...
class Orchestrator:
    ...
    def __init__(
        ...
        logger.info(
            f"Orchestrator initialized: model={model_type}, xai={xai_method}, style={explanation_style}"
        )
    ...
    def train(self, X_train, y_train, feature_names):
        ...
        self.xai_agent.initialize(self.decision_agent.model, X_train, feature_names)

        self.feature_names = feature_names
        logger.info("Orchestrator training complete")

    def explain_decision(
        self, X, idx: int, applicant_data: Optional[Dict[str, Any]] = None
    ) -> Dict[str, Any]:
        """
    ...
    def _log_explanation(
        self, explanation: Dict[str, Any], original_data: Dict[str, Any]
    ):
