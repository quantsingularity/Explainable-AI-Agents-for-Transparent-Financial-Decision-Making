...
class EvidenceCollector:
    ...
    def collect(
        self, applicant_data: Dict[str, Any], model_metadata: Dict[str, Any]
    ) -> Dict[str, Any]:
        """
        ...
        logger.debug(
            f"Collected evidence for {len(evidence['feature_policies'])} features"
        )

        return evidence

    def _get_similar_cases(
        self, applicant_data: Dict[str, Any], n_cases: int = 3
    ) -> List[Dict[str, Any]]:
        """
